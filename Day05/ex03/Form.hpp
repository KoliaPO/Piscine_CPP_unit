...
public:
	...
	public:
		NoSignedException();
		NoSignedException(NoSignedException const &obj);
		~NoSignedException() throw();
		NoSignedException &operator=(NoSignedException const &obj);
		virtual const char* what() const throw ();
	};
	...
	public:
		NoFormNameException();
		NoFormNameException(NoFormNameException const &obj);
		~NoFormNameException() throw();
		NoFormNameException &operator=(NoFormNameException const &obj);
		virtual const char* what() const throw ();
	};
	...
	virtual void executeType() const = 0;
