...
Form::NoSignedException::NoSignedException()
{
}
...
Form::NoSignedException::NoSignedException(NoSignedException const &obj)
{
	*this = obj;
}

Form::NoSignedException &Form::NoSignedException::operator=(Form::NoSignedException const &obj)
{
	(void)obj;
	return *this;
}

Form::NoFormNameException::NoFormNameException()
{
}

Form::NoFormNameException::~NoFormNameException() throw()
{
}

Form::NoFormNameException::NoFormNameException(NoFormNameException const &obj)
{
	*this = obj;
}

Form::NoFormNameException &Form::NoFormNameException::operator=(Form::NoFormNameException const &obj)
{
	(void)obj;
	return *this;
}

const char* Form::NoFormNameException::what() const throw()
{
	return ("(Form) Bad name Form !!");
}
